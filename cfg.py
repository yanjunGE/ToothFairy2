...
def parse_args():    
    ...
    parser.add_argument('-dataset', default='toothfairy' ,type=str,help='dataset name')
    parser.add_argument('-sam_ckpt', default='sam_vit_b_01ec64.pth' , help='sam checkpoint address')
    ...
    parser.add_argument('-multimask_output', type=int, default=49 , help='the number of masks output for multi-class segmentation, set 2 for REFUGE dataset.')
    parser.add_argument(
    '-data_path',
    type=str,
    default='C:/Users/geyan/Projet_IAV/Medical-SAM-Adapter-main/data',
    help='The path of segmentation data')
    # '../dataset/RIGA/DiscRegion'
    # '../dataset/ISIC'
    # opt = parser.parse_args()
    opt, unknown = parser.parse_known_args()
    print("Unknown arguments:", unknown)  # 打印被忽略的参数，调试时使用
    return opt
